...
```yaml
      - uses: supernovae-st/nika-action@64d1cbace684e1f495eeab8ebe10bc37811b9f8e # v1.0.20
```
...
| `engine-version` | `0.118.7` | the engine release to install, verified against the release's `SHA256SUMS` |
