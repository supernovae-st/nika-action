...
```yaml
      - uses: supernovae-st/nika-action@b4a5995d3822cd09a037c870ae30e44f5289fdc2 # v1.0.25
```
...
| `engine-version` | `0.120.3` | the engine release to install, verified against the release's `SHA256SUMS` |
